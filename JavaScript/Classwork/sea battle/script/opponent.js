...
const model1 = {
    ...
    fire: function (guess) { // метод получает координаты выстрела
        ...
        view1.displayMessage("промах"); // приказываем представлению, вывести сообщение о промахе
        return false;
    },
...
const model2 = {
    ...
    fire: function (guess) { // метод получает координаты выстрела
        ...
        view2.displayMessage("промах"); // приказываем представлению, вывести сообщение о промахе
        return false;
    },
...
let name1 = prompt('игрок 1, введите Ваше имя'); 
// объект контроллер
const controller1 = {
...
let mouseFire1 = document.getElementById('table1');
mouseFire1.onclick = function (e) {
    const alphabet = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"];
    let row = alphabet[e.target.id.charAt(0)];
    let column = e.target.id.charAt(1);
    let guess = row + column;
    controller1.processGuess1(guess);
};

let mouseFire2 = document.getElementById('table2');
mouseFire2.onclick = function (e) {
    const alphabet = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"];
